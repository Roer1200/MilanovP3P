...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    ...
    <p>        
        <asp:LinkButton ID="LinkButton1" runat="server" 
            PostBackUrl="/pages/Picture_Add.aspx">Voeg nieuwe foto toe</asp:LinkButton>
        ...
        <asp:SqlDataSource ID="sds_picture" runat="server" 
            ...
            InsertCommand="INSERT INTO [picture] ([name], [category], [price], [image], [description]) VALUES (@name, @category, @price,  @image, @description)" 
            SelectCommand="SELECT * FROM [picture]" 
            UpdateCommand="UPDATE [picture] SET [name] = @name, [category] = @category, [price] = @price, [image] = @image, [description] = @description WHERE [id] = @id">
            <DeleteParameters>
